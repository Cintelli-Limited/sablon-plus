...
class NodePropertiesTest < SablonPlus::TestCase
  def setup
  ...
  def test_empty_node_properties_converison
    ...
    props = SablonPlus::HTMLConverter::NodeProperties.new('w:pPr', {}, @inc_props.new)
  ...
  def test_simple_node_property_converison
    ...
    props = SablonPlus::HTMLConverter::NodeProperties.new('w:pPr', props, @inc_props.new)
  ...
  def test_node_property_with_nil_value_converison
    props = { 'b' => nil }
    props = SablonPlus::HTMLConverter::NodeProperties.new('w:rPr', props, @inc_props.new)
  ...
  def test_properties_filtered_on_init
    ...
    props = SablonPlus::HTMLConverter::NodeProperties.new('w:rPr', props, %w[rStyle])
    assert_equal({ rStyle: 'EndnoteText' }, props.instance_variable_get(:@properties))
  end

  def test_transferred_properties
    props = { 'pStyle' => 'Paragraph', 'rStyle' => 'EndnoteText' }
    props = SablonPlus::HTMLConverter::NodeProperties.new(nil, props, %w[pStyle])
  ...
  def test_node_properties_paragraph_factory
    props = { 'pStyle' => 'Paragraph' }
    props = SablonPlus::HTMLConverter::NodeProperties.paragraph(props)
  ...
  def test_node_properties_table_factory
    ...
    props = SablonPlus::HTMLConverter::NodeProperties.table(props)
  ...
  def test_node_properties_table_row_factory
    props = { 'jc' => 'left' }
    props = SablonPlus::HTMLConverter::NodeProperties.table_row(props)
  ...
  def test_node_properties_table_cell_factory
    ...
    props = SablonPlus::HTMLConverter::NodeProperties.table_cell(props)
  ...
  def test_node_properties_run_factory
    props = { 'color' => 'FF00FF' }
    props = SablonPlus::HTMLConverter::NodeProperties.run(props)
